...
```
fs.nr_open = 1048576 лимит кол-во файловых дескрипторов для процесса, но по ulimit -n  1024 (максимальное число открытых файлов и в данном варианте такое число не достижимо
```
